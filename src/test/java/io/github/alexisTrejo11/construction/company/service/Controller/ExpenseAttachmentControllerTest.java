package io.github.alexisTrejo11.construction.company.service.Controller;

import io.github.alexisTrejo11.construction.company.modules.expenses.controller.ExpenseAttachmentController;
import io.github.alexisTrejo11.construction.company.modules.expenses.service.AttachmentService;
...
import io.github.alexisTrejo11.construction.company.shared.file.FileHandler;
...
class ExpenseAttachmentControllerTest {
    ...
    void getAttachmentsByExpenseId_Success() throws Exception {
        ...
        mockMvc.perform(get("/v1/api/employees/expenses/{expenseId}/attachments", expenseId))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.data[0].attachment_url").value("http://example.com/file/test.txt"));
    }
