package io.github.alexisTrejo11.construction.company.modules.expenses.repository;
...
public interface ExpenseRepository extends JpaRepository<Expense, Long> {
    ...
    @Query("SELECT new io.github.alexisTrejo11.construction.company.shared.dto.expenses.ExpenseSummaryDTO(SUM(e.amount), COUNT(e)) " +
        "FROM Expense e " +
