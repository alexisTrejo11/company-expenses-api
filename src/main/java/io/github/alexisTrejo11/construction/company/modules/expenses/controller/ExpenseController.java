package io.github.alexisTrejo11.construction.company.modules.expenses.controller;

import io.github.alexisTrejo11.construction.company.modules.expenses.service.ExpenseService;
import io.github.alexisTrejo11.construction.company.modules.user.service.JWTService;
import io.github.alexisTrejo11.construction.company.modules.notification.service.NotificationService;
import io.github.alexisTrejo11.construction.company.shared.ResponseWrapper;
import io.github.alexisTrejo11.construction.company.shared.dto.expenses.ExpenseDTO;
import io.github.alexisTrejo11.construction.company.shared.dto.expenses.ExpenseRejectDTO;
import io.github.alexisTrejo11.construction.company.shared.dto.expenses.ExpenseSummary;
import io.github.alexisTrejo11.construction.company.shared.enums.ExpenseStatus;
...
public class ExpenseController {
  ...
  @Operation(summary = "Get Expense s by Date Range", description = "Fetch the s of expenses within a specified date range.")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Expense s successfully fetched."),
  })
  @GetMapping("/s")
  public ResponseWrapper<ExpenseSummary> getExpenseSummaryByDateRange(@RequestParam(required = false) LocalDateTime startDate,
    ...
    if (startDate == null || endDate == null) {
      ...
      return ResponseWrapper.success(monthlySummary, "Monthly Expense s Successfully Fetched With Date Range: " + monthlySummary.getSummaryDateRange());
    }

    ExpenseSummary expenseSummary = expenseService.getExpenseSummaryByDateRange(startDate, endDate);

    return ResponseWrapper.success(expenseSummary, "Expense s Successfully Fetched With Date Range: " + expenseSummary.getSummaryDateRange());
  }
