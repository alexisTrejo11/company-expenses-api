...
REST API for corporate expense reporting: employees submit claims with receipts, managers approve or reject, finance processes reimbursements, and admins configure company settings—with JWT security, Flyway migrations, and Docker deploy.

| Field | Value |
| --- | --- |
| Project ID | company-expenses-api |
| Version | 1.0.0 |
| Language | Java |
...
| Status | stable |
| Featured | Yes |
| Repository | https://github.com/alexisTrejo11/company-expenses-api |
